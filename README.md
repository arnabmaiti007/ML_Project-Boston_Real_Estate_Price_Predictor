# Machine Learning Project - Boston Real Estate Price Predictor
...
2. There is a file named 'train_model.py' run it in any python IDE to train the model.
3. Then to predict price open the file named 'predict_price.py' give proper attributes and run.
